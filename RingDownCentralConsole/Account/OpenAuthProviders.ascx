<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="RingDownCentralConsole.Account.OpenAuthProviders" %>

<div id="socialLoginList">
   <%-- Items commented out because not needed by manager 2/5/2018 R. Dean--%>
