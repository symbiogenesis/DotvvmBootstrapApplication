<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminStatuses.aspx.cs" Inherits="RingDownCentralConsole.AdminStatuses" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <table>
      <tr><td>Status Code</td> 
          <td> <asp:TextBox ID="txtStatusCode" runat="server"></asp:TextBox></td> <td> 
              &nbsp;</td></tr>
      <tr><td></td> 
          <td> 
              <asp:RequiredFieldValidator ID="ReqStatusCode" runat="server" ControlToValidate="txtStatusCode" ErrorMessage="*" ForeColor="Red">
               </asp:RequiredFieldValidator>
              <asp:CompareValidator ID="CompareValidator1" runat="server" 
         ControlToValidate="txtStatusCode" Type="Double" Operator="DataTypeCheck"
        ErrorMessage="Numbers Only" ForeColor="OrangeRed"></asp:CompareValidator>
