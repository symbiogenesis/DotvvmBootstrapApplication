...
namespace DotvvmBootstrapApplication.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                var connectionString = Configuration.GetValue<string>(nameof(AppSettings.BootstrapDb));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IDbInitializer dbInitializer)
        {
            ...
            using (var serviceScope = app.ApplicationServices.GetRequiredService<IServiceScopeFactory>().CreateScope())
            {
                ...
                var escortLogDbContext = serviceScope.ServiceProvider.GetService<BootstrapDbContext>();
